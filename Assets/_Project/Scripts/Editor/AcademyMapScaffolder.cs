...
namespace GuildAcademy.EditorTools
{
    public static class AcademyMapScaffolder
    {
        ...
        public static void CreateAcademySceneScaffolds()
        {
            ...
            EditorUtility.DisplayDialog("Academy Map Scaffolder", "学園シーンの雛形を作成しました。", "OK");
        }
            ...
            return new Dictionary<string, List<PortalLink>>
            {
                ...
                },
                {
                    ...
                    new List<PortalLink>
                    {
                        ...
                        new PortalLink { Name = "ToDormitory", Position = new Vector2(-9f, -4f), TargetScene = "Academy_dormitory", TargetSpawn = "from_hallway" },
                        new PortalLink { Name = "ToTrainingGround", Position = new Vector2(9f, -4f), TargetScene = "Academy_TrainingGround", TargetSpawn = "from_hallway" },
                    }
                },
                {
                    "Academy_Cafeteria",
                ...
                },
                {
                    ...
                    new List<PortalLink>
                    {
                        new PortalLink { Name = "ToHallway", Position = new Vector2(0f, 8f), TargetScene = "Academy_Hallway", TargetSpawn = "from_dormitory" },
                    }
                },
                {
                    "Academy_StudentCouncilRoom",
                ...
                },
                {
                    ...
                    new List<PortalLink>
                    {
                        new PortalLink { Name = "ToHallway", Position = new Vector2(0f, 8f), TargetScene = "Academy_Hallway", TargetSpawn = "from_training_ground" },
                    }
                },
            };
        }
